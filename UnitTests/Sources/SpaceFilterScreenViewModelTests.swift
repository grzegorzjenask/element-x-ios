...
@MainActor
class SpaceFilterScreenViewModelTests: XCTestCase {
    var viewModel: SpaceFilterScreenViewModelProtocol!
    
    var context: SpaceFilterScreenViewModelType.Context {
        viewModel.context
    }
    
    override func setUpWithError() throws {
        viewModel = SpaceFilterScreenViewModel()
    }
